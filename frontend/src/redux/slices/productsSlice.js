...
export const updateProduct = createAsyncThunk("products/updateProduct", async ({ id, productData }) => {
    ...
    const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/products/${id}`, productData, { headers: { Authorization: `Bearer ${localStorage.getItem("userToken")}` } })
    return response.data
})
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(updateProduct.pending, (state) => {
                ...
                /*returns the index (position) of the product in the array. */
